<template>
  <v-app>
    ...
    >
      <v-list dense>
        ...
        <v-list-tile v-for="item in menuItems" :key="item.title" :to="item.link">
          ...
          <v-list-tile v-if="userIsAuthenticated" @click="onLogout" router to="/signin">
            <v-list-tile-action>
    ...
    <v-toolbar-items class="hidden-sm-and-down">
      ...
      <v-btn flat v-if="userIsAuthenticated" @click="onLogout" router to="/signin"><v-icon left>exit_to_app</v-icon>Logout</v-btn>
    </v-toolbar-items>
    </v-toolbar>
    <main>
      <v-content>
